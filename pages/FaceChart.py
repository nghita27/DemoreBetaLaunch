...
#    with st.form("login_form_facechart"):
#        st.subheader("Log In")
...
#                # Load user profile for sketches and gallery
...
#    with st.form("register_form_facechart"):
...
#    with st.form("forgot_form_facechart"):
